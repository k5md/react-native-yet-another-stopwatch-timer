...
declare module 'react-native-yet-another-stopwatch-timer' {
  /**
   * @template T
  ...
  /**
   * @typedef {Object} TransitionExtraContextProps
   * @property {string} name - transition name, used to route and create correct transition object in transitionHandler
   * @property {OnBeforeTransition} [onBeforeTransition]
   * @property {OnAfterTransition} [onAfterTransition]
   */
  export type TransitionExtraContextProps = {
    name: string,
   ...
   *
   */
  export type TransitionExtraContext = TransitionExtraContextProps & Record<string, any>;
  ...
  */
   ...
   */
  export declare function OnBeforeTransition(
   ...
   * @returns {void}
   */
  export declare function OnAfterTransition(
    transitionContext: TransitionContext,
    transitionExtraContext: TransitionExtraContext,
    transition: Transition,
  ): (void);
   ...
   */
  export declare function TransitionHandler(
    transitionContext: TransitionContext,
    transitionExtraContext: TransitionExtraContext,
  ): (Transition | void);
   ...
   * @returns {void}
   */
  export declare function TransitionRouter(
    transitionContext: TransitionContext,
    transitionExtraContext: TransitionExtraContext,
  ): (void);
   ...
   * @returns {void}
   */
  export declare function TransitionTo(
    transitionExtraContext: TransitionExtraContext,
  ): (void);
  ...
  */
  export declare function TimingHandler(
    context: {
      timingInterval: any,
      state: SharedValue<any>,
      counter: SharedValue<any>,
   ...
   * @returns {void}
   */
  export declare function RemoveTiming(timeout: SharedValue): (void);
  ...
  */
   ...
   */
  export type Styles = NamedStyles<StylesProps> & Record<string, AnyStyle>
 ...
 export type Renderers = {
  ...
  export type StopwatchProps = Omit<CounterProps, StopwatchDefaultedPropKeys> & Partial<Pick<CounterProps, StopwatchDefaultedPropKeys>>;
  ...
  export type TimerProps = Omit<StopwatchProps, TimerDefaultedPropKeys> & Partial<Pick<StopwatchProps, TimerDefaultedPropKeys>>;
