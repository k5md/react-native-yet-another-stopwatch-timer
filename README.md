...
| :--------  | :----  | :---------- |
| initialState | any | initial value for state SharedValue |
| initialCounterValue | any | initial value for counter SharedValue |
...
| [timingInterval](#timingInterval) | any | intended time interval for timing handler to perform counter updates, by default counter gets increased by timingInterval |
